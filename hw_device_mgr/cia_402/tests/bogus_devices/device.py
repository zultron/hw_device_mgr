...
class BogusCiA402V1Servo(BogusCiA402Device, CiA402SimDevice, BogusCiA301V1Servo):
    name = "bogo_cia402_v1_servo"
    product_code = 0xB0905020


class BogusCiA402V2Servo(BogusCiA402Device, CiA402SimDevice, BogusCiA301V2Servo):
